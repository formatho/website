/**
 * Service Worker for Formatho (v4)
 ...
 *   (offline only).
 *
 * v4 exists because the previous sw.js URL got pinned in HTTP caches
 * (browser + CDN) for up to 30 days, so update checks kept receiving
 * the old script. A fresh filename sidesteps every cache layer.
 * The bumped CACHE_NAME also discards any precached stale HTML.
 */

const CACHE_NAME = 'formatho-v4-2026-08-29'
const STATIC_ASSETS = [
  '/',
  '/index.html',
  '/manifest.json',
