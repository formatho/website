...
const itemRe = /\{ name: '([^']+)', description: '((?:[^'\\]|\\.)*)', route: '(\/tools\/[^']+)', iconName: '[^']+'(?:, subcategory: '[^']+')? ?\}/g
...
lines.push('')
lines.push('The same tool catalog powers the free browser tools at formatho.com - every tool page states what it does, how to use it, and how AI agents can call it via MCP. Private and secure, runs in your browser; nothing you enter is uploaded, logged, or stored.')
lines.push('')
