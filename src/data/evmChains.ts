...
export const evmChains: EvmChain[] = [
  ...
  },
  {
    ...
    nativeToken: 'HYPE',
    tokenSymbol: 'HYPE',
    rpc: 'https://hyperliquid-calculus-testnet.drpc.org',
    explorer: 'https://purplerock.hyperliquid.cloud',
    explorerName: 'HyperEVM Explorer',
    type: 'L1',
    blurb: 'HyperEVM is the EVM-compatible execution layer built directly into Hyperliquid L1. Combines HyperCore orderbook speed with full EVM smart contract compatibility.',
    gasNote: 'Gas paid in HYPE, ~70ms block time',
    popularTokens: [],
  },
  {
    slug: 'katana',
    ...
    nativeToken: 'Ether',
    tokenSymbol: 'ETH',
    rpc: 'https://rpc.katana.tetsuo.io',
    explorer: 'https://katanaexplorer.com',
    explorerName: 'Katana Explorer',
    type: 'L2',
    blurb: 'Katana is a yield-bearing L2 built on Tetsuo. Powered by Polygon and focused on DeFi liquidity. ETH held on Katana automatically earns yield.',
    gasNote: 'Gas paid in ETH, yield-bearing L2',
    popularTokens: [],
  },
  {
    slug: 'monad',
    ...
    type: 'L1',
    blurb: 'Monad is a high-performance L1 with parallel EVM execution — up to 10,000 TPS with 1-second block times. Same EVM compatibility, 100x throughput.',
    gasNote: 'Gas paid in MON, 1s blocks, parallel execution',
    popularTokens: [],
  },
  {
    slug: 'robinhood',
    ...
    nativeToken: 'Ether',
    tokenSymbol: 'ETH',
    rpc: 'https://rpc.grove.critical.tech/robinhood/mainnet',
    explorer: 'https://robinhood.explorevms.com',
    explorerName: 'Robinhood Explorer',
    type: 'L2',
    blurb: 'Robinhood Chain is an Arbitrum Orbit L2 built by Robinhood for stock and crypto trading. Tokenized equities, DeFi, and 24/7 markets.',
    gasNote: 'Gas paid in ETH, Arbitrum Orbit L2',
    popularTokens: [],
  },
  {
    slug: 'unichain',
    ...
    type: 'L2',
    blurb: 'Unichain is the OP Superchain L2 built by Uniswap Labs. DeFi-native execution with 250ms flashblocks and built-in MEV redistribution.',
    gasNote: 'Gas paid in ETH, 250ms flashblocks',
    popularTokens: [],
  },
  {
    slug: 'stable',
    ...
    explorer: 'https://explorer.stable.io',
    explorerName: 'Stable Explorer',
    type: 'L2',
    blurb: 'Stable is a USDC-native L2 built on OP Stack. Gas is paid in USDC instead of ETH — no volatility. Designed for payments and stablecoin DeFi.',
    gasNote: 'Gas paid in USDC — no ETH needed',
    popularTokens: [],
  },
  {
    slug: 'tempo',
    ...
    type: 'L2',
    blurb: 'Tempo is an EVM L2 focused on institutional finance. Tokenized real-world assets, compliant DeFi, and enterprise-grade infrastructure.',
  ...
  },
  {
    ...
    type: 'L2',
    blurb: 'World Chain is the OP Superchain L2 built by Worldcoin. Prioritizes verified humans over bots — World ID holders get gas priority.',
    gasNote: 'Gas paid in ETH, human-priority blocks',
    popularTokens: [],
  },
]
