...
export const devStacks: DevStack[] = [
  ...
  },
  {
    ...
    tools: [
      ...
      { name: 'Security Policy Generator', route: '/tools/policy-generator', desc: 'Generate password, access control, and incident response policies — SOC 2 ready' },
      { name: 'TLS Certificate Checker', route: '/tools/tls-checker', desc: 'CC6.1: Verify encryption in transit — cert expiry, issuer, security configuration' },
      { name: 'Security Headers Analyzer', route: '/tools/security-headers', desc: 'CC6.1: HSTS, CSP, X-Frame-Options, X-Content-Type-Options compliance' },
      { name: 'CSP Generator', route: '/tools/csp-generator', desc: 'CC6.1: Build Content-Security-Policies per OWASP guidance' },
      { name: 'Cookie Security Analyzer', route: '/tools/cookie-analyzer', desc: 'CC6.1: Session cookie flags — Secure, HttpOnly, SameSite' },
      { name: 'JWT Debugger', route: '/tools/jwt', desc: 'CC6.1: Token authentication validation and expiry verification' },
      { name: 'CORS Tester', route: '/tools/cors-tester', desc: 'CC6.1: Cross-origin access control verification' },
      { name: 'Password Strength Analyzer', route: '/tools/password-strength-analyser', desc: 'CC6.1: Credential policy enforcement' },
      { name: 'Hash Generator', route: '/tools/hash-text', desc: 'CC6.7: Cryptographic key generation (Argon2id, bcrypt)' },
    ],
    tips: [
      'Start with the SOC 2 Readiness Checklist to see your current gap — most startups are at 30-40% without knowing it.',
      'The Security Policy Generator produces auditors-approved templates for the three most-requested policies in a SOC 2 audit.',
      'Security headers and TLS checks map directly to CC6.1 (Security) — fix these first for quick wins.',
    ],
  },
  {
    slug: 'sap',
