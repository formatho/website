...
export const tools: ToolCategory[] = [
  {
    ...
    items: [
      ...
      { name: 'Function Selector Calculator', description: 'Compute 4-byte Solidity function selectors from signatures with Keccak-256. Batch mode for ABI work.', route: '/tools/function-selector', subcategory: 'Smart Contract Dev', iconName: 'FunctionSquare' },
