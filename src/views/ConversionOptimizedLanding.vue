...
<template>
  <div class="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white">
    <!-- Announcement Banner -->
    <div class="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 px-4 text-center text-sm font-medium">
      <span class="mr-2">🎉</span>
      <span>Beta Program Open:</span>
      <span class="mx-2">Only</span>
      <span class="font-bold">{{ betaSpots }} spots left</span>
      <span class="mx-2">out of 10!</span>
      <a href="/beta" class="ml-2 underline hover:no-underline">Apply Now →</a>
    </div>
      ...
      <div class="max-w-7xl mx-auto">
        <div class="text-center mb-12">
          ...
          <p class="text-xl text-slate-400 max-w-3xl mx-auto mb-8 leading-relaxed">
            Run multiple AI agents in parallel. Switch between models. Automate workflows.
            <span class="text-white font-semibold">100% privacy-first.</span> No cloud required.
          </p>
    ...
    <section class="py-20 px-6">
      <div class="max-w-4xl mx-auto text-center">
        ...
        <!-- Urgency Indicator -->
        <div class="inline-flex items-center gap-2 bg-red-500/10 border border-red-500/20 rounded-lg px-4 py-2 mb-8">
