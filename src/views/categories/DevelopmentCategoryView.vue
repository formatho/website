...
onMounted(() => {
  const structuredData = {
    ...
    '@type': 'CollectionPage',
    name: 'SQL, JSON, and Git Developer Utilities',
    description: 'SQL query formatting, database diagram generation, JSON linting, and Docker conversion tools that run free and browser-native.',
    url: 'https://formatho.com/category/development',
    about: {
      '@type': 'Thing',
      name: 'Developer Utilities',
      description: 'SQL, JSON, Git, and development tools'
    },
...
<template>
  <div class="container mx-auto px-4 py-12">
    ...
    <div class="mb-12 text-center max-w-4xl mx-auto">
      <h1 class="text-4xl md:text-5xl font-bold mb-4">SQL, JSON, and Git Developer Utilities</h1>
      <p class="text-muted-foreground text-lg">
        SQL query formatting, database diagram generation, JSON linting, and Docker conversion tools that run free and browser-native.
      </p>
    </div>
