...
onMounted(() => {
  const structuredData = {
    ...
    '@type': 'CollectionPage',
    name: 'Web, Network, and HTTP Utilities',
    description: 'JWT inspection, URL encoding, user agent parsing, and subnet calculation with zero server footprint.',
    url: 'https://formatho.com/category/web-network',
    about: {
      '@type': 'Thing',
      name: 'Web and Network Tools',
      description: 'HTTP, JWT, URL, and network utilities'
    },
...
<template>
  <div class="container mx-auto px-4 py-12">
    ...
    <div class="mb-12 text-center max-w-4xl mx-auto">
      <h1 class="text-4xl md:text-5xl font-bold mb-4">Web, Network, and HTTP Utilities</h1>
      <p class="text-muted-foreground text-lg">
        JWT inspection, URL encoding, user agent parsing, and subnet calculation with zero server footprint.
      </p>
    </div>
