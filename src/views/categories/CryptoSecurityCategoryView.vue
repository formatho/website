...
onMounted(() => {
  const structuredData = {
    ...
    '@type': 'CollectionPage',
    name: 'Privacy-First Security and Hash Tools',
    description: 'Generate secure Argon2id hashes, unique identifiers, passphrases, and RSA key pairs locally in your browser for absolute privacy.',
    url: 'https://formatho.com/category/crypto-security',
    about: {
      '@type': 'Thing',
      name: 'Security and Cryptography Tools',
      description: 'Hash generators, encryption, and security utilities'
    },
...
<template>
  <div class="container mx-auto px-4 py-12">
    ...
    <div class="mb-12 text-center max-w-4xl mx-auto">
      <h1 class="text-4xl md:text-5xl font-bold mb-4">Privacy-First Security and Hash Tools</h1>
      <p class="text-muted-foreground text-lg">
        Generate secure Argon2id hashes, unique identifiers, passphrases, and RSA key pairs locally in your browser for absolute privacy.
      </p>
    </div>
