...
import { faqHowTo } from '../../scripts/faq-howto-data'
...
const visibleFaqs = computed(() => {
  ...
  // faqHowTo covers the top-25 pages whose FAQPage schema this feeds.
  return [...(toolSpecificFAQ[route.path] || []), ...(faqHowTo[route.path] || [])]
})
