  ...
  setup(__props) {
    ...
    watch(tomlInput, () => {
      try {
        ...
        yamlOutput.value = yaml__default.dump(parsed, { indent: 2, lineWidth: -1 });
      } catch (e) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "h-full flex flex-col p-4 gap-4 bg-muted/30" }, _attrs))}><div class="flex items-center justify-between"><h1 class="text-3xl font-bold tracking-tight">TOML to YAML Converter</h1></div><div class="grid grid-cols-1 lg:grid-cols-2 gap-4 flex-1 min-h-0">`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/views/TomlToYamlView.vue");
