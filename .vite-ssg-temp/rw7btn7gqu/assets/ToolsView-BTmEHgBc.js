import { defineComponent, computed, resolveComponent, mergeProps, withCtx, unref, createTextVNode, toDisplayString, createVNode, useSSRContext } from "vue";
...
import { e as _sfc_main$1 } from "../main.mjs";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="container mx-auto px-4 py-8"><div class="text-center mb-12"><h1 class="text-4xl font-bold tracking-tight mb-4">All Developer Tools</h1><p class="text-xl text-muted-foreground max-w-2xl mx-auto"> Privacy-first tools that run entirely in your browser. No data sent to servers. </p></div><div class="space-y-12"><!--[-->`);
      ssrRenderList(categories.value, (category) => {
        _push(`<div class="space-y-4"><h2 class="text-2xl font-semibold border-b border-border pb-2">${ssrInterpolate(category)}</h2><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4"><!--[-->`);
        ssrRenderList(getToolsByCategory(category), (tool) => {
          _push(ssrRenderComponent(_component_router_link, {
            key: tool.path,
            to: tool.path,
            class: "group",
            onMouseenter: ($event) => prefetchTool(tool.path)
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(ssrRenderComponent(unref(_sfc_main$2), { class: "h-full hover:border-primary hover:shadow-lg transition-all duration-200" }, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(ssrRenderComponent(unref(_sfc_main$3), null, {
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(`<div class="flex items-start gap-3"${_scopeId3}><span class="text-3xl"${_scopeId3}>${ssrInterpolate(tool.icon)}</span><div class="flex-1"${_scopeId3}>`);
                            _push4(ssrRenderComponent(unref(_sfc_main$4), { class: "text-lg group-hover:text-primary transition-colors" }, {
                              default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                if (_push5) {
                                  _push5(`${ssrInterpolate(tool.name)}`);
                                } else {
                                  return [
                            ...
                            return [
                              createVNode("div", { class: "flex items-start gap-3" }, [
                                createVNode("span", { class: "text-3xl" }, toDisplayString(tool.icon), 1),
                                createVNode("div", { class: "flex-1" }, [
                                  createVNode(unref(_sfc_main$4), { class: "text-lg group-hover:text-primary transition-colors" }, {
                                    default: withCtx(() => [
                                      createTextVNode(toDisplayString(tool.name), 1)
                                    ]),
                                    _: 2
                      ...
                      _push3(ssrRenderComponent(unref(_sfc_main$5), null, {
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(ssrRenderComponent(unref(_sfc_main$6), { class: "text-sm" }, {
                              default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                if (_push5) {
                                  _push5(`${ssrInterpolate(tool.description)}`);
                                } else {
                                  return [
                            ...
                            return [
                              createVNode(unref(_sfc_main$6), { class: "text-sm" }, {
                                default: withCtx(() => [
                                  createTextVNode(toDisplayString(tool.description), 1)
                                ]),
                                _: 2
                ...
                return [
                  createVNode(unref(_sfc_main$2), { class: "h-full hover:border-primary hover:shadow-lg transition-all duration-200" }, {
                    default: withCtx(() => [
                      createVNode(unref(_sfc_main$3), null, {
                        default: withCtx(() => [
                          createVNode("div", { class: "flex items-start gap-3" }, [
      ...
      _push(`<!--]--></div><div class="mt-16 text-center"><div class="inline-flex items-center gap-2 px-4 py-2 bg-muted rounded-full text-sm"><span class="font-semibold">${ssrInterpolate(tools.length)}</span><span class="text-muted-foreground">tools available</span></div></div></div></div>`);
    };
  }
});
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/views/ToolsView.vue");
